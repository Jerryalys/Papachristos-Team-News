        ...
        <div>
          <GridContainer>
            <GridItem xs={12} sm={12} md={4}>
              <Card carousel>
                <GridItem className={classes.imgCardTop}>
                  <img src={require("../img/prt180812.jpg").default} className={imageClasses} />
                </GridItem>
                ...
                <CardBody>
                  <h4 className={classes.description}>
                   Πολλά συγχαρητήρια στον αθλητή μας Κώστα Γκελαούζο που 
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card carousel>
                <GridItem className={classes.imgCardTop}>
                  <img src={require("../img/prt180720.jpg").default} className={imageClasses} />
                </GridItem>
                <h3 className={classes.cardTitle}>
                  20 July 2018
                </h3>
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card carousel>
                <GridItem className={classes.imgCardTop}>
                  <img src={require("../img/prt180716.jpg").default} className={imageClasses} />
                </GridItem>
                <h3 className={classes.cardTitle}>
                  16 July 2018
                </h3>
             ...
             <GridItem xs={12} sm={12} md={4}>
              <Card carousel>
                <GridItem className={classes.imgCardTop}>
                  <img src={require("../img/prt180627.jpg").default} className={imageClasses} />
                </GridItem>
                <h3 className={classes.cardTitle}>
                  27 June 2018
                </h3>
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card carousel>
                <GridItem className={classes.imgCardTop}>
                  <img src={require("../img/prt180626.jpg").default} className={imageClasses} />
                </GridItem>
                <h3 className={classes.cardTitle}>
                  26 June 2018
                </h3>
